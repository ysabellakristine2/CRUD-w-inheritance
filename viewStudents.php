...
<div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-3xl">
    <h1 class="text-2xl font-bold text-center text-blue-600 mb-6">Registered Students</h1>
                    ...
                    <?php foreach ($students as $row): ?>
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                <a href="edit_student.php?id=<?= $row['id'] ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white px-2 py-1 rounded text-xs">Edit</a>
                                <a href="delete_student.php?id=<?= $row['id'] ?>" class="bg-red-500 hover:bg-red-600 text-white px-2 py-1 rounded text-xs" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
